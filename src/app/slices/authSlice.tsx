...
const initialState: AuthState = {
    token: CookieHelper.getCookie("app-token") || null,
    isAuthenticated: Boolean(CookieHelper.getCookie("app-token")) || false,
    ...
    reducers: {
        ...
        setInitialCredentials: (
            ...
            if (action.payload.token) {
                console.log(action);
                CookieHelper.setCookie("app-token", action.payload.token, 7);
        ...
        logout: (state: AuthState) => {
            CookieHelper.deleteCookie("app-token");
